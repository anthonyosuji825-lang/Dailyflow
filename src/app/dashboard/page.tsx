        ...
        {weekDays.map((d) => (
          <div key={d.day} style={{
            ...
            <div style={{
              ...
              color: d.isToday ? 'white' : d.isPast ? '#d1d5db' : '#374151',
              border: d.isToday ? 'none' : '1px solid #f3f4f6',
              cursor: 'pointer',
            }}>
              {d.date}
            </div>
                ...
                {stats.recentDays.map((day: any) => (
                  <div key={day.date} style={{
                    ...
                    <span style={{
                      ...
                      borderRadius: 999,
                      background: day.status === 'completed' ? '#ecfdf5'
                        : day.status === 'missed' ? '#fef2f2'
                        : day.status === 'inprogress' ? '#fffbeb' : '#eef2ff',
                      color: day.status === 'completed' ? '#10b981'
                        : day.status === 'missed' ? '#ef4444'
                        : day.status === 'inprogress' ? '#f59e0b' : '#6366f1',
                    }}>
                      {day.status}
                    </span>
                  </div>
                    ...
                    <div key={goal.id} style={{
                      ...
                      <div style={{
                        ...
                        <span style={{
                          ...
                          color: daysLeft < 3 ? '#ef4444'
                            : daysLeft < 7 ? '#f59e0b' : '#6b7280',
