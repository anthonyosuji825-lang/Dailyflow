...
export default function CalendarPage() {
  ...
  const addTask = () => {
    ...
    setForm(prev => ({
      ...prev,
      tasks: [...prev.tasks, { text: prev.newTask.trim(), completed: false }],
      newTask: '',
    }));
  };
  ...
  const totalDays = calendarData ? Object.keys(calendarData).length : 0;
  ...
  for (let i = firstDay - 1; i >= 0; i--) {
    calendarCells.push({
      ...
      currentMonth: false,
      dateStr: formatDate(year, month - 1, daysInPrevMonth - i),
    });
  }
  ...
  return (
    <div style={{ maxWidth: 1200 }}>
      ...
      <div style={{
        ...
        {[
          { label: 'Days Logged', value: totalDays, color: '#6366f1' },
          { label: 'Days Completed', value: completedDays, color: '#10b981' },
            ...
            return (
              <div key={index}
                ...
                style={{
                  ...
                  borderRight: (index + 1) % 7 === 0 ? 'none' : '1px solid #f9fafb',
                  borderBottom: index < 35 ? '1px solid #f9fafb' : 'none',
                ...
                <div style={{
                  ...
                  background: isToday
                    ...
                    : 'transparent',
                  color: isToday ? 'white' : isCurrentMonth ? '#111827' : '#9ca3af',
                  marginBottom: 4,
                }}>
                  {cell.day}
                </div>
      ...
      <div style={{
        ...
        {Object.entries(statusConfig).map(([key, val]) => (
          <div key={key} style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
            ...
            <span style={{ fontSize: 12, color: '#9ca3af' }}>{val.label}</span>
          </div>
        ))}
      </div>
                  ...
                  {Object.entries(statusConfig).map(([key, val]) => (
                    <button key={key}
                      ...
                      style={{
                        ...
                        border: `1px solid ${form.status === key ? val.color : '#e5e7eb'}`,
                        background: form.status === key ? val.bg : 'white',
                        color: form.status === key ? val.color : '#6b7280',
